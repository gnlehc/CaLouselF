...
public class SellerUploadItemPage {
	...
	public SellerUploadItemPage(Stage stage) {
		this.stage = stage;
	...
	private void handleBack() {
		SellerHomePage previousPage = new SellerHomePage(stage);
	...
	private void handleUploadItem() {
		...
		Item item = new Item(itemName, itemCategory, itemSize, itemPrice, "Pending");
